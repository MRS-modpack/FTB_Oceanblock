...
onEvent("player.tick", (e) => {
    ...
    if (e.player.alive && e.player.world.dimension == "minecraft:the_end") {
        ...
        const head =
            e.player.headArmorItem == "better_diving:diving_mask" ||
            e.player.headArmorItem == "better_diving:rebreather" ||
            e.player.headArmorItem == "better_diving:reinforced_diving_mask";
        const chest =
            e.player.chestArmorItem == "better_diving:standard_o2_tank" ||
            e.player.chestArmorItem == "better_diving:high_capacity_o2_tank" ||
            e.player.chestArmorItem == "better_diving:reinforced_o2_tank";
        const legs =
            e.player.legsArmorItem == "better_diving:wetsuit_leggings" ||
            e.player.legsArmorItem == "better_diving:improved_wetsuit_leggings" ||
            e.player.legsArmorItem == "better_diving:reinforced_wetsuit_leggings";
        const feet =
            e.player.feetArmorItem == "better_diving:fins" ||
            e.player.feetArmorItem == "better_diving:ultra_glide_fins" ||
            e.player.feetArmorItem == "better_diving:reinforced_fins";
