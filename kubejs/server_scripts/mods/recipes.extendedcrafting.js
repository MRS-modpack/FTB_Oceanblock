    ...
    event.recipes.extendedcrafting.shaped_table({
        ...
        key: {
            ...
            D: {
                ...
                count: 1,
                nbt: '{BlockEntityTag:{GasTanks:[{stored:{amount:512000L,gasName:"mekanism:ethene"},Tank:0b}],id:"mekanism:ultimate_chemical_tank"},mekData:{GasTanks:[{stored:{amount:512000L,gasName:"mekanism:ethene"},Tank:0b}]}}',
            },
            E: {
                type: "nbt_ingredient_predicate:nbt_includes",
                item: "mekanism:ultimate_chemical_tank",
                count: 1,
                nbt: '{BlockEntityTag:{GasTanks:[{stored:{amount:512000L,gasName:"mekanismgenerators:fusion_fuel"},Tank:0b}],id:"mekanism:ultimate_chemical_tank"},mekData:{GasTanks:[{stored:{amount:512000L,gasName:"mekanismgenerators:fusion_fuel"},Tank:0b}]}}',
            },
            F: {
                item: "mekanism:creative_fluid_tank",
            },
            G: {
                ...
                item: "mekanism:ultimate_chemical_tank",
                count: 1,
                nbt: '{BlockEntityTag:{GasTanks:[{stored:{amount:512000L,gasName:"mekanism:nutritional_paste"},Tank:0b}],id:"mekanism:ultimate_chemical_tank"},mekData:{GasTanks:[{stored:{amount:512000L,gasName:"mekanism:nutritional_paste"},Tank:0b}]}}',
            },
            H: {
                type: "nbt_ingredient_predicate:nbt_includes",
                item: "mekanism:ultimate_chemical_tank",
                count: 1,
                nbt: '{BlockEntityTag:{GasTanks:[{stored:{amount:512000L,gasName:"mekanism:uranium_hexafluoride"},Tank:0b}],id:"mekanism:ultimate_chemical_tank"},mekData:{GasTanks:[{stored:{amount:512000L,gasName:"mekanism:uranium_hexafluoride"},Tank:0b}]}}',
            },
        },
        result: {
